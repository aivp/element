                                ...
                                "el-checkbox",
                                {
                                  ...
                                  on: {
                                    change: function(value) {
                                      _vm.handleShortcutClick(shortcut, value)
                                    }
                                  },
                                  model: {
                                    value: shortcut.checked,
                                    callback: function($$v) {
                                      _vm.$set(shortcut, "checked", $$v)
                                    },
                                    expression: "shortcut.checked"
                                  }
                                },
...
/* harmony default export */ var datevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleShortcutClick: function handleShortcutClick(shortcut, value) {
      if (shortcut.onClick) {
